import { InjectedStyle } from '../injectStyleMixin';
export type ThemeOptions = 'light' | 'dark' | 'os';
export declare const themeMixin: <T extends CustomElementConstructor>(superclass: T) => {
    new (...params: any[]): {
        "__#14526@#globalStyle": InjectedStyle;
        readonly theme: ThemeOptions;
        readonly styleId: string;
        "__#14526@#_themeResource": Promise<void | Record<string, any>>;
        "__#14526@#fetchTheme"(): Promise<Record<string, any>>;
        readonly "__#14526@#themeResource": Promise<void | Record<string, any>>;
        "__#14526@#loadGlobalStyle"(): Promise<void>;
        "__#14526@#loadComponentsStyle"(): Promise<void>;
        "__#14526@#getFontsConfig"(): Promise<Record<string, {
            url?: string;
        }>>;
        "__#14526@#loadFonts"(): Promise<void>;
        "__#14526@#applyTheme"(): Promise<void>;
        "__#14526@#onThemeChange": () => void;
        "__#14526@#loadTheme"(): void;
        "__#14526@#toggleOsThemeChangeListener": (listen: boolean) => void;
        init(): Promise<void>;
        ...
        nonce: string;
        "__#14517@#setNonce": (() => void) & (() => void);
        "__#14512@#observeMappings": {} & {} & {} & {} & {} & {} & {} & {} & {};
        ...
        "__#14510@#logger": import("../loggerMixin").Logger;
        ...
        "__#14516@#configCacheClear": (() => void) & (() => void);
        "__#14516@#_configResource": Promise<import("../configMixin").Config>;
        "__#14516@#fetchConfig": (() => Promise<import("../configMixin").Config>) & (() => Promise<import("../configMixin").Config>);
        "__#14515@#callbacks": Map<string, () => void> & Map<string, () => void>;
        onReset: ((sectionId: string, callback: () => void | Promise<void>) => () => void) & ((sectionId: string, callback: () => void | Promise<void>) => () => void);
        reset: ((...sectionIds: string[]) => Promise<void>) & ((...sectionIds: string[]) => Promise<void>);
        "__#14513@#handleError": ((attrName: string, newValue: string) => void) & ((attrName: string, newValue: string) => void) & ((attrName: string, newValue: string) => void) & ((attrName: string, newValue: string) => void) & ((attrName: string, newValue: string) => void) & ((attrName: string, newValue: string) => void);
        "__#14514@#lastBaseUrl"?: string;
        "__#14514@#workingBaseUrl"?: string;
        "__#14514@#getResourceUrls": ((filename: string) => (URL & {
            baseUrl: string;
        }) | (URL & {
            baseUrl: string;
        })[]) & ((filename: string) => (URL & {
        ...
        "__#14520@#getComponentsVersion"(): Promise<string>;
        "__#14520@#descopeUi": Promise<any>;
        readonly descopeUi: Promise<any>;
        "__#14520@#loadDescopeUiComponent"(componentName: string): Promise<any>;
        "__#14520@#getDescopeUi"(): Promise<any>;
