...
export declare const modalMixin: <T extends CustomElementConstructor>(superclass: T) => {
    new (...params: any[]): {
        ...
        "__#14516@#configCacheClear"(): void;
        "__#14516@#_configResource": Promise<import("../configMixin").Config>;
        "__#14516@#fetchConfig": () => Promise<import("../configMixin").Config>;
        "__#14511@#isInit": boolean;
        "__#14515@#callbacks": Map<string, () => void>;
        onReset(sectionId: string, callback: () => void | Promise<void>): () => void;
        reset(...sectionIds: string[]): Promise<void>;
        "__#14513@#handleError": ((attrName: string, newValue: string) => void) & ((attrName: string, newValue: string) => void);
