...
declare const RoleManagementWidget: {
    new (...params: any[]): {
        init(): Promise<void>;
        "__#14@#createNotificationContent"({ type, msg }: {
            type: "success" | "error";
            msg: string;
        }): string;
        "__#14@#createNotification"(type: "success" | "error"): {
        ...
        "__#14@#onNotificationsUpdate": (notifications: {
            type: "success" | "error";
            msg: string;
        }[]) => void;
        "__#29641@#isInit": boolean;
        connectedCallback: (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void) & (() => void);
        accessKey: string;
        ...
        "__#5@#api": {
            role: {
                search: (config: SearchRolesConfig) => Promise<Role[]>;
                deleteBatch: (roleNames: string[]) => Promise<any>;
                create: (config: CreateRoleConfig) => Promise<Role[]>;
                update: (config: UpdateRoleConfig) => Promise<Role[]>;
            };
            tenant: {
                getTenantPermissions: () => Promise<{
        ...
        actions: _reduxjs_toolkit.CaseReducerActions<{
            ...
            searchRoles: _reduxjs_toolkit.AsyncThunk<any, void | SearchRolesConfig, {
                extra: {
                    api: {
                        role: {
                            search: (config: SearchRolesConfig) => Promise<Role[]>;
            ...
            createRole: _reduxjs_toolkit.AsyncThunk<any, CreateRoleConfig, {
                extra: {
                    api: {
                        role: {
                            search: (config: SearchRolesConfig) => Promise<Role[]>;
            ...
            updateRole: _reduxjs_toolkit.AsyncThunk<any, UpdateRoleConfig, {
                extra: {
                    api: {
                        role: {
                            search: (config: SearchRolesConfig) => Promise<Role[]>;
            ...
            deleteRoles: _reduxjs_toolkit.AsyncThunk<any, string[], {
                extra: {
                    api: {
                        role: {
                            search: (config: SearchRolesConfig) => Promise<Role[]>;
            ...
            getTenantPermissions: _reduxjs_toolkit.AsyncThunk<any, never, {
                extra: {
                    api: {
                        role: {
                            search: (config: SearchRolesConfig) => Promise<Role[]>;
        ...
        "__#13@#onInput": (this: any, ...args: any[]) => void;
        ...
        "__#12@#onIsRoleSelectedUpdate": (isEditable: boolean) => void;
        ...
        editRoleModal: _descope_sdk_component_drivers.ModalDriver;
        "__#11@#permissionsMultiSelect": _descope_sdk_component_drivers.MultiSelectDriver;
        "__#11@#initCancelButton"(): void;
        "__#11@#initSubmitButton"(): void;
        ...
        "__#10@#initDeleteButton"(): void;
        "__#10@#onIsRoleSelectedUpdate": (isSelected: boolean) => void;
        deleteRolesModal: _descope_sdk_component_drivers.ModalDriver;
        "__#9@#initDeleteRoleModal"(): Promise<void>;
        createButton: _descope_sdk_component_drivers.ButtonDriver;
        "__#8@#initCreateButton"(): void;
        createRoleModal: _descope_sdk_component_drivers.ModalDriver;
        "__#7@#permissionsMultiSelect": _descope_sdk_component_drivers.MultiSelectDriver;
        "__#7@#initCreateRoleModal"(): Promise<void>;
        "__#7@#updatePermissionsMultiSelect": () => Promise<void>;
        rolesTable: _descope_sdk_component_drivers.GridDriver<Role>;
        "__#15@#initRolesTable"(): void;
        "__#15@#onRolesListUpdate": (rolesList: {
            editable: string;
            name: string;
            description: string;
            permissionNames: string[];
...
export { RoleManagementWidget as default };
